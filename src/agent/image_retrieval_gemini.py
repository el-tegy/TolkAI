...
# Example usage
query_string = "Image of the 'insert' tab in Microsoft Word;Image of the 'picture' button in Microsoft Word;Image of the 'save' button in Microsoft Word"
#multiple_query_image_retrieval(query_string)
multiple_query_image_retrieval2(query_string)

# Print the resulting set
#print("Final list_url:", list_url)
#print(image_retrieval_pipeline("Image of the 'new project' button in Power BI"))
